...
/** Winged level-badge artwork, keyed by level number (falls back to the level-10 art past the illustrated range). */
export function getBadgeSrc(level) {
  return BADGES_BY_LEVEL[level] || BADGES_BY_LEVEL[((level - 1) % 10) + 1];
}
